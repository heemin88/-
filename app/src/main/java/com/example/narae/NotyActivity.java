...
public class NotyActivity extends AppCompatActivity {
                        ...
                        Task<Void> voidTask = firestore.collection("users").document("asdf")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(NotyActivity.this, "감사합니다.", Toast.LENGTH_LONG).show();
                                        onBackPressed();
                                    }
                                })
    ...
    public void whenNo(View view) {
        onBackPressed();
        Toast.makeText(NotyActivity.this, "no", Toast.LENGTH_LONG).show();
    }

    public void pushNotion(View view) { //push알람
        PendingIntent mPendingIntent = PendingIntent.getActivity(NotyActivity.this, 0, new Intent(getApplicationContext(), MainActivity.class), PendingIntent.FLAG_UPDATE_CURRENT);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(NotyActivity.this, NOTIFICATION_CHANNEL_ID)
